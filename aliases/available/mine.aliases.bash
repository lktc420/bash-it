...
alias rbdicpt='if [ "$TDH_VERSION" = "3.4" ]; then cd shark; sbt/sbt clean; cd ..; ./compile.sh shark; else cd inceptor; sbt/sbt clean package; cd ..; fi'
alias rbdngmr='if [ "$TDH_VERSION" = "3.4" ]; then cd spark; sbt/sbt clean; cd ../shark; sbt/sbt clean; cd ..; ./compile.sh init; ./compile spark; ./compile shark; else cd spark; sbt/sbt clean publish-local; cd ../inceptor; sbt/sbt clean package; cd ..; fi'
